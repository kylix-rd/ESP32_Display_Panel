...
#else
#define ENABLE_TAG_PRINT_DEBUG_LOG() do {} while(0)
#endif
...
#else
#define ERROR_CHECK_LOGE(tag, err, format, ...) do {} while(0)
#define OTHER_CHECK_LOGE(tag, format, ...) do {} while(0)
#endif
