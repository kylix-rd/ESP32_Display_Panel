...
/* Handle special Kconfig options */
    ...
    #include "sdkconfig.h"
    #ifdef CONFIG_ESP_PANEL_BOARD_CONF_SKIP
        #define ESP_PANEL_BOARD_CONF_SKIP
    #endif
#endif

/* If "ESP_Panel_Board_Conf.h" is available from here, try to use it later */
#ifdef __has_include
    #if __has_include("ESP_Panel_Board_Conf.h")
        #ifndef ESP_PANEL_BOARD_CONFIG_INCLUDE_SIMPLE
            #define ESP_PANEL_BOARD_CONFIG_INCLUDE_SIMPLE
        #endif
    #elif __has_include("../../ESP_Panel_Board_Conf.h")
        #ifndef ESP_PANEL_BOARD_CONFIG_INCLUDE_OUTSIDE
            #define ESP_PANEL_BOARD_CONFIG_INCLUDE_OUTSIDE
        #endif
    #endif
#endif

/* If "ESP_Panel_Board_Conf.h" is not skipped, include it */
#ifndef ESP_PANEL_BOARD_CONF_SKIP
    #ifdef ESP_PANEL_BOARD_CONFIG_PATH                           /* If there is a path defined for "ESP_Panel_Board_Conf.h" use it */
        #define __TO_STR_AUX(x) #x
        #define __TO_STR(x) __TO_STR_AUX(x)
        #include __TO_STR(ESP_PANEL_BOARD_CONFIG_PATH)
        #undef __TO_STR_AUX
        #undef __TO_STR
    #elif defined(ESP_PANEL_BOARD_CONFIG_INCLUDE_SIMPLE)         /* Or simply include if "ESP_Panel_Board_Conf.h" is available */
        #include "ESP_Panel_Board_Conf.h"
    #elif defined(ESP_PANEL_BOARD_CONFIG_INCLUDE_OUTSIDE)
        #include "../../ESP_Panel_Board_Conf.h"                /* Or include if "../../ESP_Panel_Board_Conf.h" is available */
    #else
        #define ESP_PANEL_BOARD_CONF_IGNORE             /* Or ignore all configurations if none of the above is available */
    #endif
#endif
...
#endif /* ESP_PANEL_BOARD_CONF_IGNORE */
