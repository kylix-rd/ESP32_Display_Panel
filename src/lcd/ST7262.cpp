...
ESP_PanelLcd_ST7262::ESP_PanelLcd_ST7262(ESP_PanelBus *bus, int rst_io):
    ESP_PanelLcd(bus, 24, rst_io, NULL, 0)
{
}
...
void ESP_PanelLcd_ST7262::init(void)
{
...
void ESP_PanelLcd_ST7262::reset(void)
{
    if (panel_config.reset_gpio_num >= 0) {
