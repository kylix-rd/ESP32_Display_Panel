...
* it is also necessary to install the `NTPClient`(v3.2.1) and `ArduinoJson`(v6.21.3) libraries (open Arduino IDE -> top navigation bar -> Tools -> Manage Libraries and search directly).
...
#define WEATHER_API_KEY       "91c57a80e449b8837b06b38d2460ee69"    //Fill in your openweather API KEY here
#define WEATHER_CITY          "Shanghai"                            //Fill in the city for which you want to obtain weather information here, e.g: Shanghai
#define SERVER_IP             "ntp6.aliyun.com"                     //Fill in the NTP server URL here, e.g: ntp6.aliyun.com
...
#define TIME_OFFSET             28800      // Time offset (in seconds)
#define TIME_UPDATE_INTERVAL    60000      // Time update interval (in milliseconds)
...
bool wifi_list_switch = false;      //flag indicating whether Wi-Fi is connected
...
/** LVGL Integration for ESP Panel Control **/
/** This code provides functions for handling display flushing, touch input, and LVGL task handling **/
